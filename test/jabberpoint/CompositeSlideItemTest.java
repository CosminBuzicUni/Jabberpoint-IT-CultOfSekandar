...
public class CompositeSlideItemTest {
    ...
    public void testGetKindIsComposite() {
        assertEquals(jabberpoint.model.SlideItemKind.COMPOSITE, composite.getKind());
    }
    ...
    public void testGetBoundingBoxEmpty() {
        ...
        assertEquals(style0.getLeading(), bounds.height); // leading is reserved even for empty composites
        assertEquals(style0.getIndent(), bounds.x);
